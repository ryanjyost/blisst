...
<!-- Top Info -->
<div class="my-author-user">

     <?php echo do_shortcode('[userpro template=view user=author card_img_width=100 card_showbio=1 card_showsocial=0 max_width=90% include_fields=description]')?>
...
?>
    ...
    <div class="userpro-bookmark-area">
      <p>Check out <?php echo get_the_author(); ?>'s recent bookmarks </p>

      <ul>
       <div class="userpro-bookmark-container">
       <?php

       foreach ($userpro_fav->get_bookmarks($author_id) as $post_id => $collection) {
        ...
        ?>
          ...
          <li>
            ...
            <div class="userpro-bookmark-title">
              <a href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php echo $post->post_title; ?></a>
            </div>
            ...
            <?php if(get_post_type($post) == 'essay') { ?>
            ...
            <?php if(get_post_type($post) == 'audio') { ?>
            ...
            <?php if(get_post_type($post) == 'speech') { ?>
            ...
            <?php if(get_post_type($post) == 'media') { ?>
...
<?php if(get_post_type($post) !== 'mumble') { ?>
            <div class="bookmark-author"><?php echo "$article_author";?></div> <div class="bookmark-author"></div><div class="bookmark-source"><?php echo "$source";?></div>
<?php } ?>
...
<!-- Feed of author's  stuff-->
<div class="author-loop-title">

    <?//php
       // $author = get_the_author();
       //echo "All of $author's contributions";
...
<div class="wide-feed">
    ...
    $author_id = $wp_query->get_queried_object_id();
      $id = $author_id;
      $args = array( 'post_type' => array('mumble', 'article', 'book', 'essay', 'study', 'speech', 'audio', 'video', 'media'), 'posts_per_page' => -1, 'author' => $id, 'orderby' => 'date' );
      $loop = new WP_Query( $args );
      while ( $loop->have_posts() ) : $loop->the_post();
    ?>

    <?php x_get_view( 'global', 'wide-loop-display' ); ?>
